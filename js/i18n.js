...
const TRANSLATIONS = {
  en: {
    ...
    'qf3.f1':'Combines Intensive Repair Infusion ($228) with dual-frequency precision ultrasound',
    ...
    'bk.t-qf2':'Intensive Repair Infusion — $228 / 60\'',
    'bk.t-qf3':'Multi-Dimensional Sculpting Treatment — $288 / 75\'',
    'bk.t-s1':'Classic Pore Purifying Treatment — $89 / 60\'',
    'bk.t-s2':'LED Light Therapy — $49 / 30\'',
  ...
  zh: {
    ...
    'qf1.f4':'适合所有肤质的日常维护',
    'qf1.btn':'立即预约此疗程 →',
    'qf2.h3':'肌底修护肤', 'qf2.dur':'/ 60分钟',
    'qf2.f1':'净澈焕肤（$188）+ 专属安瓶精华导入',
    'qf2.f2':'5款对症选择：抗皱 / 美白 / 收毛孔 / 舒缓 / 提亮',
    'qf2.f3':'深层修护肌底，针对性改善肤质问题',
    'qf2.f4':'提升肌肤光泽与健康状态',
    'qf2.btn':'立即预约此疗程 →',
    'qf3.h3':'多维塑颜焕肤', 'qf3.dur':'/ 75分钟',
    'qf3.f1':'肌底修护焕肤（$228）+ 双频密集超声波（10MHz + 3MHz）',
    'qf3.f2':'叠加双频密集超声波将安瓶活性成分推入真皮层',
    'qf3.f3':'促进胶原蛋白生成并同步紧致提拉',
    'qf3.f4':'实现焕肤 + 修护 + 抗衰三重进阶效果',
    'qf3.btn':'立即预约此疗程 →',
    // Service 1
    ...
    's5.f1':'根源靶向，从源头精准清除疣体',
    's5.f2':'比冷冻更温和，无水疱、不留痕',
    's5.f3':'较激光与外用药更彻底、洁净',
    's5.f4':'单次见效快，恢复期短，不影响日常',
    's5.btn':'立即预约此疗程 →',
    // Add-on
    'addon.h4':'附加项目',
    ...
    'bk.t-qf2':'肌底修护肤 — $228 / 60分钟',
    'bk.t-qf3':'多维塑颜焕肤 — $288 / 75分钟',
    'bk.t-s1':'经典毛孔净化护理 — $89 / 60分钟',
    'bk.t-s2':'LED光疗 — $49 / 30分钟',
...
const concernDataI18n = {
  ...
  zh: {
    ...
    acne:        { title: '针对痘痘与爆痘',     text: '蓝光LED光疗（$49）精准靶向痤疮细菌；经典毛孔净化护理（$89）有效疏通毛孔、减少多余油脂；中胚层导入微针（$269）还可淡化痘疤、细腻肤质。', service: 'LED Light Therapy' },
