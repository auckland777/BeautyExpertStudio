...
const TRANSLATIONS = {
  en: {
    ...
    'letter.greeting':'A note from Hannah',
    'letter.sigcaption':'Senior Beauty Specialist · 30 Years',
    // Hero card
    ...
    'qf1.f1':'Sterile single-use probe: replaced for every client and discarded after use — fully sterile throughout the treatment.',
    'qf1.f2':'Patented dual-vortex hydro technology: pressurised solution penetrates deep into pores, dissolves impurities, then gently suctions them into the waste reservoir. The sebum film, stratum corneum, collagen-elastin fibres and capillaries stay intact — avoiding the thinning barrier, enlarged pores and skin laxity caused by harsh cleansing.',
    'qf1.f3':'Korea-original ampoules matched to the device: clinic-grade high-activity formulas precisely tuned to the machine for deeper penetration and stronger results, conditioning the skin from within for continuously improving condition.',
    'qf1.f4':'Alcohol-free, non-irritating: safe for sensitive skin and post-procedure recovery — suitable for long-term care across all skin types.',
  ...
  zh: {
    ...
    'quote.sig':'，资深高级美容师',
    'letter.greeting':'Hannah 写给您',
    'letter.sigcaption':'资深高级美容师 · 三十年从业经验',
    // Hero card
    ...
    'qf1.f1':'无菌次抛探头：一客一换，用完即弃，全程无菌。',
    'qf1.f2':'专利双涡轮水动力技术：原液通过涡旋增压深入毛孔，溶解污垢后温和吸附排至污水瓶。不损伤皮脂膜、角质层、弹力胶原纤维及毛细血管，规避越做屏障越薄、毛孔越大、脸越垮。',
    'qf1.f3':'韩国仪器原厂配套原液：院线级高活性成分，与仪器精准适配，渗透更深、功效更强，深层调理肤质，让肌肤状态持续优化。',
    'qf1.f4':'无酒精无刺激：敏感肌、医美术后都可安心做，适合所有肤质长期养护。',
    'qf1.btn':'立即预约此疗程 →',
